...
ARG VITE_HAZARD_SOURCE=mock
ARG VITE_ENABLE_MACHINE_TRANSLATIONS=false
ENV VITE_API_BASE_URL=$VITE_API_BASE_URL
ENV VITE_KEYCLOAK_URL=$VITE_KEYCLOAK_URL
ENV VITE_KEYCLOAK_REALM=$VITE_KEYCLOAK_REALM
ENV VITE_KEYCLOAK_CLIENT_ID=$VITE_KEYCLOAK_CLIENT_ID
ENV VITE_HAZARD_SOURCE=$VITE_HAZARD_SOURCE
ENV VITE_ENABLE_MACHINE_TRANSLATIONS=$VITE_ENABLE_MACHINE_TRANSLATIONS
