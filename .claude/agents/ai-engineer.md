Read `AGENTS.md`, `CLAUDE.md`, and `.opencode/agents/ai-engineer.md`. Own online AI runtime in `be/src/ai` and offline training in `ai/`; keep training out of request handling.
