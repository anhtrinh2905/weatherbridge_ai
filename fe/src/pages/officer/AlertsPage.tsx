...
import { AlertLocalizationPanel } from "../../features/operations/AlertLocalizationPanel";
...
export function OfficerAlertsPage() {
  ...
  const [localizing, setLocalizing] = useState<string | null>(null);
